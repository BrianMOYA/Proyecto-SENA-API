                    ...
                    <div>
                        <asp:GridView ID="gvCliente" runat="server" AutoGenerateColumns="False" DataKeyNames="idCliente" DataSourceID="SqlDataSourceClientes" HorizontalAlign="Center" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" AllowPaging="True" Width="90%">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="emailCliente" HeaderText="Email Cliente" SortExpression="emailCliente" />
                                <asp:BoundField DataField="celularCliente" HeaderText="Celular Cliente" SortExpression="celularCliente" />
                                <asp:BoundField DataField="negocioCliente" HeaderText="Negocio Cliente" SortExpression="negocioCliente" />
                                <asp:BoundField DataField="direccionNegocioCliente" HeaderText="Direccion Negocio Cliente" SortExpression="direccionNegocioCliente" />
