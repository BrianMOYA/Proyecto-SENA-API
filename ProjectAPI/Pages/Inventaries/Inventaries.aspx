                ...
                <center>
                    ...
                    <div>
                        <div>
                            ...
                            <asp:SqlDataSource ID="ApidataSource" runat="server" ConnectionString="<%$ ConnectionStrings:APICliente %>" SelectCommand="SELECT [idProducto], [nombreProducto] FROM [Producto]"></asp:SqlDataSource>
                        </div>
                         <br />
                        <div>
