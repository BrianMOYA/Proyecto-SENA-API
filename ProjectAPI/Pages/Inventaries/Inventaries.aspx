<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Page.Master" CodeBehind="Inventaries.aspx.vb" Inherits="ProjectAPI.Inventaries_" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <title>La Molienda | Inventarios</title>
                            ...
                            <center>
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        &nbsp;<asp:TextBox ID="txtIngreso" runat="server" required></asp:TextBox>
                                    </div>

                                    <div>
                                        <asp:Label ID="lblTotalBodega" runat="server" Text="Total en bodega:"></asp:Label>
                                        &nbsp;<asp:TextBox ID="txtTotalBodega" runat="server" required></asp:TextBox>
                                    </div>
                                    <div>
